            ...
            <tbody>
                <tr v-for="obj, chave in dadosFiltrados" :key="chave"> 
                    ...
                    <td v-if="visualizar.visivel || atualizar || remover">
                        <button v-if="visualizar.visivel" :data-bs-toggle="visualizar.dataToggle" :data-bs-target="visualizar.dataTarget" class="btn btn-outline-secondary btn-sm">Visualizar</button>
